          ...
          <div className="hidden sm:flex items-center gap-3 lg:gap-4">
            {isAuthenticated && isFaceVerified ? (
              ...
              <>
                ...
                <Link to="/admin" className="px-4 py-2 text-sm font-medium text-purple-700 hover:bg-purple-50 rounded-lg transition-colors border border-purple-200 flex items-center gap-1">
                  ⚙️ Admin Portal
                </Link>
            ...
            {isAuthenticated && isFaceVerified ? (
              ...
              <>
                ...
                <Link
                  to="/admin"
                  onClick={closeMobile}
                  className="block px-3 py-2.5 text-sm font-bold text-purple-600 bg-purple-50 hover:bg-purple-100 border border-purple-200 rounded-lg transition-colors text-center"
                >
                  ⚙️ Admin Portal
                </Link>
                <Link
